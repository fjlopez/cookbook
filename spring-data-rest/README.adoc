...
----
include::src/main/java/es/unizar/iaaa/contacts/Contact.java[]
----
...
[source,java]
----
include::src/main/java/es/unizar/iaaa/contacts/ContactRepository.java[]
----
...
[source,sql,numbered]
----
include::src/main/resources/import.sql[lines=4..8]
----
...
image::docs/img/hal-browser.png[]